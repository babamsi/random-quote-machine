...
class SomaliQuotes extends Component {
    state = {
        current: '',
        currentBackgroud: '',
        text: ''
          ...
          <React.Fragment>
            ...
            <div>
             <Bar 
                ...
                <h1 className="tc animated bounce delay-1s">Random Quote Machine (Somali)</h1>
            {this.props.xikmado ?
                <React.Fragment>
...
const mapDispatchToProps = dispatch => ({
    ...
    req: () => actions.onSomaliQuoteReq(dispatch),
    star: (text) => dispatch(actions.starred(text)),
    onChangeModes: () => dispatch(actions.darkMode())
})

export default connect(mapStateToProps, mapDispatchToProps)(withError(SomaliQuotes, axios))
